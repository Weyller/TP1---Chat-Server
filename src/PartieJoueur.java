...
public class PartieJoueur implements Runnable {


	
	JeuUtilitaire utils = new JeuUtilitaire();
	
	private Socket socket;
	private Conversation conversation;
	private String nomJoueur;

	public PartieJoueur(Socket socket, Conversation conversation, String nomJoueur){
		this.socket = socket;
...
//=========================================================
		...
		try {
			...
			out.println("Vous etes le : " + utils.GetTypeJoueur());
			out.flush();
			//------------------------------------------------------------------------------------------------
